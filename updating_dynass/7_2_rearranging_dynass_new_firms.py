# Rearranged the dynass file with new firms (never been merged) as my supervisor wants
import pandas as pd
import numpy as np
...
file1 = open("Data/Final_outcome/dynass_76_15_plus_new_firms.tsv")
...
outcome.to_csv("BerkeleyAssignee_gvkey_76_15_plus_new_firms.tsv", sep = '\t')

outcome[outcome['year'] < 2015].to_csv("BerkeleyAssignee_gvkey_76_14_plus_new_firms.tsv", sep = '\t')
...
outcome.to_csv("BerkeleyAssignee_gvkey_76_15_plus_new_firms_FOR_QUALITY_CHECK.tsv", sep = '\t')
